...
878	0.02125775022
	...
	totalTime = totalData[:,1];
	totalPercentage = totalData[:,2];
	totalData
end

# ╔═╡ 899122fa-5da1-48ec-9c67-e73a304a7521
scatter(totalTime,totalPercentage,ls=:dash,label="Percentage",lw=10, xlabel = "Days ",yaxis="Used ICUs percentage", title="Percentage ICUs used from 15/05/2020 to 6/11/2024")
...
scatter(time,percentage,ls=:dash,label="Percentage",lw=10, xlabel = "Days ",yaxis="Used ICUs percentage", title="Percentage ICUs used from 15/05/2020 to 18/06/2021")

# ╔═╡ e9365433-86a5-4572-9182-652edcae8840
md"""
## Data ajustment with a Cubic Polynomial Model
...
rCP(value) = residueCP(value, percentage, time)
...
begin
	...
	omC=oC.minimizer
	oneaux = fill(1,size(time))
	PercentageCP = omC[1]*oneaux + omC[2]*ts + omC[3]*ts.^2 + omC[4]*ts.^3
	plot(ts, PercentageCP, lw=5, label="Optimal Cubic Polynomial")
	scatter!(time, percentage, ls=:dash, label="Percentage", lw=4, xlabel = "Time(Days)", yaxis="Percentage", legend=:bottomright, title="Optimal Cubic Polynomial Model")
end
...
git-tree-sha1 = "448cb0a5884b8a25608c9efce6d90373fc0ca52e"
