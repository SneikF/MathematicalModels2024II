...
md"""
# Modelar el movimiento de un cardumen de peces en reacción a la presencia de un depredador
## Descripción del problema
Desarrollar un campo de flujo que explique el movimiento que siguen los peces al cambiar su comportamiento dependiendo del número de individuos en el cardumen y la proximidad de los depredadores. 
La idea es asignar reglas de movimiento que estén dadas por la cercanía y dirección que tiene el depredador, y una vez establecidas, el cardumen tendrá que cambiar su dirección dependiendo del campo de flujo. Luego, con esta simulación, crearemos datos que nos indiquen cómo se comporta un cardumen.
Entender cómo funciona el movimiento de un grupo grande de peces ayudará a mejorar las estrategias de pesca
"""
...
md"""
## Metodología
Consideraremos inicialmente una trayectoria de nado de un depredador en un subconjunto de $\mathbb{R}^2$, y parametrizamos la dirección que seguirá un pez cuando este se encuentra en una posición con coordenadas específicas a través del tiempo, tomando como parámetros información como la velocidad en estas coordenadas, la posición y velocidad del depredador, la posición de peces en la cercanía, entre otros. El resultado final es un continuo de trayectorias en el plano que describen el movimiento de un pez dada una  condición inicial.
